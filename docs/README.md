...
- Roadmap actual: `docs/guides/roadmap.md`
- Plan de shell: `docs/guides/plan-shell-redistribucion-2026-01-27.md`
...
- Estado actual del retiro legacy: `docs/migrations/project_docs-extraction-report.md`
